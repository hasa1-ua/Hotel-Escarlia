...
class FotosTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $fotos = [
            // ['url', 'sala_id', 'habitacion_id']
            ['imagenes/Salas/Salaid1-1.jpg', 1, null],
            ['imagenes/Salas/Salaid1-2.jpg', 1, null],
            ['imagenes/Salas/Salaid1-1.jpg', 2, null],
            ['imagenes/Salas/Salaid1-2.jpg', 2, null],
            ['imagenes/Salas/Salaid1-1.jpg', 3, null],
            ['imagenes/Salas/Salaid1-2.jpg', 3, null],
            ['imagenes/Salas/Salaid1-1.jpg', 4, null],
            ['imagenes/Salas/Salaid1-2.jpg', 4, null],
            ['imagenes/Salas/Salaid1-1.jpg', 5, null],
            ['imagenes/Salas/Salaid1-2.jpg', 5, null],
            ['imagenes/Salas/Salaid1-1.jpg', 6, null],
            ['imagenes/Salas/Salaid1-2.jpg', 6, null],
