...
<div class="formulario">
    ...
    <form id="passwordForm" action="/Recepcionista/perfil/modificar-contraseña/{{$usuario->email}}" method="POST">
        @csrf
...
<script>
    document.getElementById('passwordForm').addEventListener('submit', async function(event) {
        ...
        try {
            const response = await fetch('/validar-contraseña-actual-Recepcionista', {
                method: 'POST',
                headers: {
