...
<div class="formulario">
    <div class="separar-enunciados">
        ...
        <div>
            <button class="modificar-contrasena" onclick="window.location.href='/Recepcionista/perfil/modificar-contraseña'">Modificar Contraseña</button>
        </div>
    </div>

    <form action="/Recepcionista/perfil/editar-usuario/{{$usuario->email}}" method="POST">
        @csrf
