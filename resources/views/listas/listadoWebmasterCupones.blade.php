...
<div class="menu">
    ...
    <a href="{{ url('/Webmaster/menu-reservas/cupones') }}" class="{{ request()->is('/Webmaster/menu-reservas/cupones') ? 'activo' : '' }}">Temporadas</a>
    <a href="{{ url('/Webmaster/menu-reservas/cupones') }}" class="{{ request()->is('/Webmaster/menu-reservas/cupones') ? 'activo' : '' }}">Regimenes</a>
</div>
