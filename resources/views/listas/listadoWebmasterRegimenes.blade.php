...
<div class="casilla">
<h1 class="Titulo">Regimenes</h1>
<div class="separation">
    <button class="button1" onclick="window.location.href='/Webmaster/menu-reservas/regimenes/crear';">Crear</button>
</div>
        ...
        <tr onclick="window.location.href='/Webmaster/menu-reservas/regimenes/editar/{{$regimen->id}}';" style="cursor: pointer;">
                ...
                <td>
                    ...
                    <form action="/Webmaster/menu-reservas/regimenes/{{ $regimen->id }}" method="POST" style="display: inline;">
                        ...
                        <button type="submit" onclick="return confirm('¿Estás seguro de que deseas eliminar este regimen?');">
...
<div>
    @include('paginate.personalpaginate', ['paginable' => $regimenes])
</div>
</div>
</div>
